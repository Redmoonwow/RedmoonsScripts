...
/// <summary>
/// Dancing Mad (Ultimate) P4 デバフのリマインダ — 上流のコピー。
/// </summary>
/// <remarks>
...
///
/// 上流からの差分は名前空間だけ。<c>SplatoonScriptsOfficial</c> のままにすると
/// FullName が公式 update.csv のエントリと一致してしまい、このコピーが公式版に
/// 上書き更新される。中身には一切手を入れていないので、上流が上がったら
/// submodule を進めて丸ごと取り直せばよい。
///
/// 公式版と同時に有効にすると同じ通知が二重に出る。どちらか片方だけを使うこと。
/// </remarks>
